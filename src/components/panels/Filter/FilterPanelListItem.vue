    ...
    <tr>
        ...
        <td v-if="!isResponsiveMobile" class="state">
            <v-tooltip v-if="state !== null" top>
                ...
                <span>{{ $t('Panels.FilterPanel.Avg') }}: {{ avgState }} %</span>
            </v-tooltip>
        </td>
        <td class="current">
            <v-tooltip top :disabled="!(measured_min_index !== null || measured_max_index !== null)">
                <template #activator="{ on, attrs }">
                ...
                <span>
                    {{ $t('Panels.FilterPanel.Max') }}: {{ measured_max_index }}
                    <br />
                    {{ $t('Panels.FilterPanel.Min') }}: {{ measured_min_index }}
                </span>
            </v-tooltip>
            <div v-if="rpm !== null">
...
@Component
export default class FilterPanelListItem extends Mixins(BaseMixin) {
